            ...
            child: Container(
              ...
              child: Center(
                child: Container(
                  ...
                  color: i < widget.currentStep ? Theme.of(context).primaryColor : Theme.of(context).disabledColor,
                ),
              ),
            ),
          ),
        ...
        children: <Widget>[
          ...
          Expanded(
            child: AnimatedCrossFade(
              firstChild: Container(height: 0.0),
              secondChild: widget.steps[widget.currentStep].content,
              firstCurve: const Interval(0.0, 0.6, curve: Curves.fastOutSlowIn),
              secondCurve: const Interval(0.4, 1.0, curve: Curves.fastOutSlowIn),
              sizeCurve: Curves.fastOutSlowIn,
              crossFadeState: _isCurrent(widget.currentStep) ? CrossFadeState.showSecond : CrossFadeState.showFirst,
              duration: kThemeAnimationDuration,
            ),
          ),
        ],
